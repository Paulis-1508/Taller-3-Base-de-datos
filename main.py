...
#client = MongoClient(os.environ["mongodb://ISIS2304E02202610:X8zbL7mua5ZQ@157.253.236.88:8087"])
# TODO: conectarse al cluster Admonsis  
# client = MongoClient("mongodb://<usuario>:<contraseña>@157.253.236.88:8087")
client = MongoClient("mongodb://ISIS2304E02202610:X8zbL7mua5ZQ@157.253.236.88:8087")
# TODO: conectarse a la base de datos Admonsis  
# db = client["ISIS*******"]
db = client["ISIS2304E02202610"]
